...
const jsons = require('./gulp-tasks/jsons.js');
...
function source() {
  return project.splitSource()
    ...
    .pipe(gulpif(/\.css$/, styles.minify()))
    .pipe(gulpif(/\.html$/, html.minify()))
    .pipe(gulpif(/\.html$/, html.clean()))
    .pipe(gulpif(/\.json$/, jsons.minify()))
